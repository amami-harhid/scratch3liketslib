...
export class Canvas {
    ...
    static textCanvas: HTMLElement|null;
...
//        const stageCanvasWrapper = Canvas.getStageCanvasWrapper();
    ...
    static createTextCanvas( ):HTMLElement{
...
//        const stageCanvasWrapper = Canvas.getStageCanvasWrapper();
    ...
    static resize2DContext(width, height) {
        ...
        if(textCanvas != null){
            const _textCanvas = textCanvas as HTMLCanvasElement;
    ...
    static resizeMonitorCanvas(width, height) {
        ...
        const canvasArr:HTMLCollectionOf<Element> = document.getElementsByClassName(CanvasMonitor2dClassName);
