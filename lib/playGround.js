...
class PlayGround {
    ...
    static getInstance() {
        if( PlayGround._instance == undefined ) {
            console.log('playGround new !!!!')
            PlayGround._instance = new PlayGround();
        }
        console.log('playGround return')
...
//        keyboard.startWatching();
        ...
        console.log('before Element.init()');
...
//        this.clearPools();
        console.log('playGround _init before _prepare')
        console.log(this);
        ...
        console.log('playGround _init complete')
        console.log(this);
